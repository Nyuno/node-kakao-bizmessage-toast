...
class ToastKakaoBizmessage {
  ...
  /**
   * Send a Kakao Alimtalk message with template parameters
   *  -  https://docs.toast.com/ko/Notification/KakaoTalk%20Bizmessage/ko/alimtalk-api-guide/#_3
   *
   ...
   */
  async sendMessages(templateCode, recipientList, options = {}) {
    const url = `/alimtalk/v1.1/appkeys/${this.options.appKey}/messages`;
   ...
   *  - https://docs.toast.com/ko/Notification/KakaoTalk%20Bizmessage/ko/alimtalk-api-guide/#_6
   *
